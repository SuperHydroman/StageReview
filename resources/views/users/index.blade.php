...
{{--                                {{$user->role}}--}}
                            ...
                            <td class="py-4 px-6">
                                <a href="{{ route('users.edit', $user->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Aanpassen</a>
                                <a href="{{ route('users.delete', $user->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline pl-5">Verwijderen</a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
